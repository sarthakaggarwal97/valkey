...
tags {"repl external:skip"} {
    ...
    # A streaming-compressed disk-based sync RDB (repl-compress-sync lz4 on
    ...
    test "Disk-based full sync with repl-compress-sync lz4 falls back to BGREWRITEAOF for AOF base" {
        start_server {overrides {repl-diskless-sync no repl-compress-sync lz4 save ""}} {
            set primary [srv 0 client]
            set primary_host [srv 0 host]
            set primary_port [srv 0 port]
            ...
            start_server {overrides {appendonly yes aof-use-rdb-preamble yes repl-diskless-sync no repl-compress-sync lz4 save ""}} {
                set replica [srv 0 client]
                set replica_log [srv 0 stdout]
