...
start_server {tags {"repl"} overrides {save ""}} {
    ...
    test {Replica repl-compression flips renegotiate upstream in both directions} {
        ...
        start_server {overrides {save "" repl-compression lz4 repl-diskless-load swapdb}} {
            ...
            # A later apply failure rolls back the compression value and must
            # also roll back the deferred reconnect request.
            assert_error {*Invalid locale name*} {
                $replica config set repl-compression no locale-collate this-locale-does-not-exist
            }
