...
unitTest __test_rio_compress_c[] = {{"test_rio_compress", test_rio_compress}, {NULL, NULL}};
unitTest __test_rio_decompress_c[] = {{"test_rio_decompress", test_rio_decompress}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_rio_compress.c", __test_rio_compress_c},
    {"test_rio_decompress.c", __test_rio_decompress_c},
