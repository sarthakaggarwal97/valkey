...
unitTest __test_compression_config_c[] = {{"test_compression_config_validation", test_compression_config_validation}, {NULL, NULL}};
...
unitTest __test_lz4_dict_c[] = {{"test_lz4DictContextLifecycle", test_lz4DictContextLifecycle}, {"test_lz4DictRoundTrip", test_lz4DictRoundTrip}, {"test_lz4DictMultipleChunks", test_lz4DictMultipleChunks}, {"test_lz4DictIncompressibleData", test_lz4DictIncompressibleData}, {"test_lz4DictMaxCompressedSize", test_lz4DictMaxCompressedSize}, {"test_lz4DictSerialization", test_lz4DictSerialization}, {"test_lz4DictSerializationZeroSize", test_lz4DictSerializationZeroSize}, {"test_lz4DictDeserializationOversized", test_lz4DictDeserializationOversized}, {NULL, NULL}};
unitTest __test_lz4_stream_c[] = {{"test_lz4StreamContextLifecycle", test_lz4StreamContextLifecycle}, {"test_lz4StreamMultipleContexts", test_lz4StreamMultipleContexts}, {"test_lz4StreamCreateAndDestroy", test_lz4StreamCreateAndDestroy}, {NULL, NULL}};
unitTest __test_lz4_stream_error_handling_c[] = {{"test_lz4StreamStateInitialization", test_lz4StreamStateInitialization}, {"test_lz4StreamContextCleanupResetsState", test_lz4StreamContextCleanupResetsState}, {"test_lz4StreamMultipleContextsIndependent", test_lz4StreamMultipleContextsIndependent}, {"test_lz4StreamNullContextHandling", test_lz4StreamNullContextHandling}, {"test_lz4StreamMultipleCreateDestroyCycles", test_lz4StreamMultipleCreateDestroyCycles}, {NULL, NULL}};
...
unitTest __test_object_c[] = {{"test_object_with_key", test_object_with_key}, {"test_embedded_string_with_key", test_embedded_string_with_key}, {NULL, NULL}};
...
unitTest __test_replication_compression_c[] = {{"test_replication_compression_old_replica", test_replication_compression_old_replica}, {"test_replication_compression_new_replica_no_lz4", test_replication_compression_new_replica_no_lz4}, {"test_replication_compression_new_replica_with_lz4", test_replication_compression_new_replica_with_lz4}, {"test_replication_compression_master_configured_lzf", test_replication_compression_master_configured_lzf}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_compression_config.c", __test_compression_config_c},
    ...
    {"test_lz4_dict.c", __test_lz4_dict_c},
    {"test_lz4_stream.c", __test_lz4_stream_c},
    {"test_lz4_stream_error_handling.c", __test_lz4_stream_error_handling_c},
    ...
    {"test_replication_compression.c", __test_replication_compression_c},
